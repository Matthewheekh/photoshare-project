...
const CreatePin = ({ user }) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
            ...
            <div className=" flex xl:flex-row flex-col justify-center items-center bg-white xl:p-5 p-3 2xl:w-4/5  w-full">
                ...
                <div className="flex flex-1 flex-col gap-6 xl:pl-5 mt-5 w-full">
                    <input
                        type="text"
                        value={title}
